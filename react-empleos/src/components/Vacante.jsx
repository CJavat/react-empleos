...
const Vacante = () => {
...

  {
    return cargando ? (
      ...
      <div className="flex flex-col justify-center gap-3 my-5 px-7 py-4 border rounded-xl border-blue-600 w-5/6 tablet:w-4/6 laptop:w-3/6 desktop:w-2/6 desktopL:w-1/6 laptop:flex-row-reverse laptop:gap-12 desktop:flex-row-reverse desktop:gap-14 desktop:mb-40 desktopL:mt-9 desktopL:mb-60">
